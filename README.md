...
```text
/zainstaluj_plugin https://raw.githubusercontent.com/gnomidlo/Arka/main/dist/UNICORN.zip?version=0.5.0
```
...
ustaw kolor szeptu 160
ustaw kolor krzyku 117
```

Mudlet raportuje te ustawienia jako indeksy ANSI odpowiednio 152, 159 i 116. Moduł używa tymczasowych triggerów ANSI 256 i nie wymaga importowania osobnego pakietu XML.
